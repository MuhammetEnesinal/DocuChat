...
namespace DocuChat.Infrastructure.Migrations
{
    ...
    [Migration("20260630132448_AddImageVisualEmbedding")]
    partial class AddImageVisualEmbedding
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DocuChat.Domain.Entities.Chat.ChatMessage", b =>
                {
                    ...
                    b.Property<Guid?>("ResponseToMessageId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ResponseToMessageId");
            ...
            modelBuilder.Entity("DocuChat.Domain.Entities.Documents.DocumentImage", b =>
                {
                    ...
                    b.HasIndex("VisualEmbedding");

                    NpgsqlIndexBuilderExtensions.HasMethod(b.HasIndex("VisualEmbedding"), "hnsw");
                    NpgsqlIndexBuilderExtensions.HasOperators(b.HasIndex("VisualEmbedding"), new[] { "vector_cosine_ops" });
            ...
            modelBuilder.Entity("DocuChat.Domain.Entities.Chat.ChatMessage", b =>
                {
                    b.HasOne("DocuChat.Domain.Entities.Chat.ChatMessage", "ResponseToMessage")
                        .WithMany()
                        .HasForeignKey("ResponseToMessageId")
                    ...
                    b.Navigation("ResponseToMessage");
