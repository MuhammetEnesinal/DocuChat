        ...
        <div className="flex flex-col items-center justify-center h-full text-center py-20 px-4">
            ...
            {popularQuestions.length > 0 ? (
                <div className="w-full max-w-lg">
                    <p className="text-xs font-medium mb-3 text-center" style={{ color: '#475569' }}>
                    ...
                    <div className="grid grid-cols-1 gap-2">
                        {popularQuestions.map((q, i) => (
                            <button key={i} onClick={() => onSelectQuestion(q)}
                                ...
                                onMouseEnter={(e) => { e.currentTarget.style.borderColor = 'var(--accent)'; e.currentTarget.style.color = '#e2e8f0'; e.currentTarget.style.background = 'rgba(59,130,246,0.05)'; }}
                                onMouseLeave={(e) => { e.currentTarget.style.borderColor = 'var(--border)'; e.currentTarget.style.color = '#94a3b8'; e.currentTarget.style.background = 'var(--surface2)'; }}>
