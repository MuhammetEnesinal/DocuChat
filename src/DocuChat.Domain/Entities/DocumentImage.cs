...
public class DocumentImage : BaseEntity
{
    ...
    /// <summary>chart | photo | diagram | logo | screenshot — opsiyonel, ileride CLIP zero-shot ile.</summary>
    public string? ImageType { get; set; }

    /// <summary>CLIP image embedding (512-dim). Multi-modal arama için. Şimdilik null.</summary>
