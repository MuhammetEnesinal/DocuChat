    ...
    return (
      <>
        <div style={{ borderRadius: '16px', overflow: 'hidden', background: 'rgba(32, 26, 58, 0.55)', border: '1px solid rgba(var(--accent-light-rgb),0.14)', backdropFilter: 'blur(24px) saturate(160%)', WebkitBackdropFilter: 'blur(24px) saturate(160%)', boxShadow: '0 8px 28px -10px rgba(0,0,0,0.4), inset 0 1px 0 rgba(255,255,255,0.04)' }}>
            <div className="management-list-header" style={{ padding: '16px 20px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '12px', borderBottom: '1px solid var(--border)', flexWrap: 'wrap' }}>
                ...
                <div className={selectMode ? 'management-select-actions' : 'management-users-actions'} style={{ display: 'flex', gap: '8px', alignItems: 'center', flexWrap: 'wrap', flex: '1 1 auto', justifyContent: 'flex-end', minWidth: 0 }}>
                    {selectMode ? (
                        <>
                        ...
                        <>
                            ...
                            <select
                                className="management-role-filter"
                                value={roleFilter ?? ''}
                            ...
                            {onBulkImport && (
                                <button onClick={onBulkImport} className="management-users-cta"
                            ...
                            <button onClick={onAdd} className="management-users-cta"
            ...
            {loading ? <UserSkeleton /> : users.length === 0 ? (
                ...
                return (
                    <div key={u.id}
                        ...
                        {!isAdmin && !selectMode && (
                            <div className="management-row-actions" style={{ display: 'flex', gap: '4px', flexShrink: 0, marginLeft: 'auto' }}>
